...
private:
    ...
    BOOL   m_bPlayerMode; // true: single player, false: rear player
    int    m_nPlayerStatus; // single mode -> 1: finish ; rear mode -> 2: finish
...
public:
    ...
    afx_msg void OnRearPlayer();
    afx_msg void OnStop();
    afx_msg void OnGetFps();
};
